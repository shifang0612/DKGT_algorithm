...
class Client:
    ...
    def train(self, w, round, Cti):
        ...
        round_lr=self.model_trainer.train(self.local_training_data, self.device, self.args, round, Cti)
        ...
        return round_lr, parameters, tst_results, gradient
