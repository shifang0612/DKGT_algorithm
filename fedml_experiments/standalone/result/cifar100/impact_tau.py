...
log_files=['./DKGT-cifar100-dir0.2-mdlcnn_cifar100-toporandom-lr0.01-epochs3-batch_size64-momentum0.9-cm500-total_clnt100-tau1.log',
           './FedAvg-cifar100-dir0.2-mdlcnn_cifar100-toporandom-lr0.01-epochs3-batch_size64-momentum0-cm500-total_clnt100-tau1.log',
           './FedAvgM-cifar100-dir0.2-mdlcnn_cifar100-toporandom-lr0.01-epochs3-batch_size64-momentum0.9-cm500-total_clnt100-tau1.log',
           './DPSGD-cifar100-dir0.2-mdlcnn_cifar100-toporandom-lr0.01-epochs1-batch_size64-momentum0-cm500-total_clnt100-tau1.log']
