...
# log_files=['./DKGT-cifar10-dir0.3-mdlcnn_cifar10-toporandom-batch_size64-lr0.01-max_norm10-epochs2-cm300-total_clnt100-tau50.log',
#            './DKGT-cifar10-dir0.3-mdlcnn_cifar10-toporandom-batch_size64-lr0.01-max_norm10-epochs3-cm300-total_clnt100-tau50.log',
#            './DKGT-cifar10-dir0.3-mdlcnn_cifar10-toporandom-batch_size64-lr0.01-max_norm10-epochs4-cm300-total_clnt100-tau50.log',
#            './DKGT-cifar10-dir0.3-mdlcnn_cifar10-toporandom-batch_size64-lr0.01-max_norm10-epochs5-cm300-total_clnt100-tau50.log',
#            './FedAvg-cifar10-dir0.3-mdlcnn_cifar10-toporandom-batch_size64-lr0.01-max_norm10-epochs2-cm300-total_clnt100-tau50.log',
#            './FedAvg-cifar10-dir0.3-mdlcnn_cifar10-toporandom-batch_size64-lr0.01-max_norm10-epochs3-cm300-total_clnt100-tau50.log',
#            './FedAvg-cifar10-dir0.3-mdlcnn_cifar10-toporandom-batch_size64-lr0.01-max_norm10-epochs4-cm300-total_clnt100-tau50.log',
