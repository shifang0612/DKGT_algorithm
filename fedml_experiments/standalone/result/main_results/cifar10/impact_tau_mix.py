...
log_files=['./DKGT-cifar10-dir0.3-mdlcnn_cifar10-topomix-lr0.01-epochs3-batch_size64-momentum0.9-cm300-total_clnt100-tau300.log',
           './FedAvg-cifar10-dir0.3-mdlcnn_cifar10-topomix-lr0.01-epochs3-batch_size64-momentum0-cm300-total_clnt100-tau300.log',
           './FedAvgM-cifar10-dir0.3-mdlcnn_cifar10-topomix-lr0.01-epochs3-batch_size64-momentum0.9-cm300-total_clnt100-tau300.log',
           './DPSGD-cifar10-dir0.3-mdlcnn_cifar10-topomix-lr0.01-epochs1-batch_size64-momentum0-cm300-total_clnt100-tau300.log']
