...
if __name__ == "__main__":
    ...
    if not os.path.exists('/gdata/dairong/DisPFL/fedml_experiments/standalone/DisPFL/LOG/' + args.dataset):
        os.makedirs('/gdata/dairong/DisPFL/fedml_experiments/standalone/DisPFL/LOG/' + args.dataset)
