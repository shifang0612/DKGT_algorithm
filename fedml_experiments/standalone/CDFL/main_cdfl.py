...
from fedml_api.standalone.CDFL.cdfl_api import cdflAPI
from fedml_api.standalone.CDFL.my_model_trainer import MyModelTrainer
...
if __name__ == "__main__":
    ...
    args.identity = "CDFL" + "-" + args.dataset + "-" + data_partition
    ...
    logger.info(model)
    cdflAPI = cdflAPI(dataset, device, args, model, model_trainer, logger)
    cdflAPI.train()
