...
if __name__ == "__main__":
    ...
    parser = add_args(argparse.ArgumentParser(description='DPSGD-standalone'))
    ...
    args.identity += "-max_norm" + str(args.max_norm)
    ...
    logger.info(model)
    dpsgdAPI = dpsgdAPI(dataset, device, args, model, model_trainer, logger)
    dpsgdAPI.train()
